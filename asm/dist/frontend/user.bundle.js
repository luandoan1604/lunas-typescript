...
/******/ 	deferredModules.push(["./src/frontend/UserApp.ts","vendors~user"]);
...
/* harmony import */ var _models_User__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/User */ "./src/frontend/models/User.ts");
...
class UserController {
    ...
    processPlayButtonClick(event) {
        ...
        if (usernameElement) {
            let user = new _models_User__WEBPACK_IMPORTED_MODULE_2__[/* User */ "a"](usernameElement.value);
            Object(class_validator__WEBPACK_IMPORTED_MODULE_1__[/* validate */ "c"])(user).then((errors) => {
                if (errors.length > 0) {
                    if (helpId) {
